		...
		<div className="">
			<div>
				...
				<div className="w-[350px] lg:w-[650px] mx-auto">
					<h2 className="sm:mt-2 md:mt-2 lg:mt-4 font-medium text-xs lg:text-sm text-black text-center">
			...
			<div className="flex flex-wrap justify-center gap-8 mt-2">
				<div className="flex flex-col">
					...
					<div className="w-[339px] h-32 lg:h-[180px] mx-auto mt-2">
						...
						<p className="text-[14px] md:text-xs lg:text-base text-center text-black">
							Ultimos 10 partidos
						</p>
						<GamesCounter />
						<div className="w-[337px] h-8 lg:w-[360px] lg:h-10 mt-4">
							<p className="text-[12px] lg:text-[15px] md:text-xs font-normal text-black text-center">
