              ...
              <RoundButton
               ...
               <div className="w-[339px] h-32 lg:h-[180px] mx-auto mt-2">
                    ...
                    <div className="w-[337px] h-8 lg:w-[360px] lg:h-10 mt-4">
                        <p className="text-[12px] lg:text-[15px] md:text-xs font-normal text-black text-center">Completá 10 partidos para validar tu participación. <br/>
                                 El 10% con mejor ranking pasa a la siguiente fase.</p>
                    </div>
