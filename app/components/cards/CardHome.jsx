...
function CardHome({ text, imageCard, href, onClick }) {
  return (
    <Link href={href}>
        <div className="bg-white rounded-md shadow-md p-4 w-[172.24px] h-[203.01px] lg:w-[233px] lg:h-auto flex flex-col items-center cursor-pointer lg:ml-[25px]" onClick={onClick}>
