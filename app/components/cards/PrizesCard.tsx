...
export const PrizesCard = ({
  ...
  return (
    <div
      ...
      <div className="flex-none w-[101px] h-[88px] rounded-lg relative overflow-hidden " >
        <Image src={tester} alt="tester" className={"absolute inset-0 w-full h-full  "
            .concat(
                "",
                imageClassName || ""
            )
     ...
     <div className="flex-grow ml-4 flex flex-col justify-center ">
        <h1 className={"text-black mt-2 text-xs  font-semibold "
          .concat(
            " ",
            titleClassName || ""
          )
