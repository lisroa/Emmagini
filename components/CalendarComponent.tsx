...
export default function CalendarComponent({ text }: CalendarComponentProps) {
	return (
		<DatePicker className="*:not-first:mt-2 border-none">
			<Label className="font-normal text-xs text-slate-500 ml-2">{text}</Label>
			<div className="flex">
